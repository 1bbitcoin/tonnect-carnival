      ...
      <div className="cyber-card rounded-2xl p-8">
        <div className="relative w-full aspect-square max-w-sm mx-auto">
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="w-16 h-16 rounded-full bg-card border-4 border-primary flex items-center justify-center shadow-[0_0_30px_rgba(0,212,255,0.8)]">
          ...
          <div
            ...
            style={{
              ...
              background: `conic-gradient(
                ...
                hsl(270 80% 50%) 45deg 90deg,
                hsl(195 100% 60%) 90deg 135deg,
                hsl(270 80% 60%) 135deg 180deg,
                hsl(195 100% 50%) 180deg 225deg,
                hsl(270 80% 50%) 225deg 270deg,
                hsl(195 100% 60%) 270deg 315deg,
                hsl(270 80% 60%) 315deg 360deg
              )`,
              boxShadow: "0 0 40px rgba(0, 212, 255, 0.6), inset 0 0 40px rgba(107, 0, 255, 0.4)",
            }}
          >
            {/* Prize Labels */}
            {prizes.map((prize, index) => {
              ...
              return (
                <div
                  ...
                  style={{
                    transform: `rotate(${angle + 22.5}deg) translateX(80px)`,
                  }}
                >
                  <div className="text-white font-bold text-lg -translate-x-1/2 -translate-y-1/2 drop-shadow-lg">
                    {prize}
                  </div>
                </div>
              );
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-2 z-20">
            <div className="w-0 h-0 border-l-8 border-r-8 border-t-12 border-l-transparent border-r-transparent border-t-primary drop-shadow-[0_0_10px_rgba(0,212,255,1)]" />
          </div>
        </div>
      </div>
